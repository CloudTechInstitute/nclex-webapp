...
<body class="dark:bg-gray-800 dark:text-white">
    <div class=" flex h-screen">
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <div class="px-6 py-4 md:flex justify-between mt-5 lg:mt-0 items-end mb-5">
                <p class="uppercase font-bold text-xl ml-10 md:ml-0">edit question</p>
            ...
            <div class="[&::-webkit-scrollbar]:w-2
                ...
                <div class="w-full px-6 mb-5 ">
                    ...
                    <div class="">
                        <?php include 'components/edit-question-form.php'; ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" src="backend/js/edit-question.js"></script>
