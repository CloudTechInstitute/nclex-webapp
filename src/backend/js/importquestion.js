document
  .getElementById("importQuestionForm")
  .addEventListener("submit", async function (e) {
    ...
    try {
      let response = await fetch("backend/uploadFile.php", {
        method: "POST",
        body: formData,
      });
      ...
      toastMessage = "Unable to upload file. Please try again.";
      toastType = "error";
    }

    // Close the modal
    let modal = document.getElementById("importQuestion-modal");
    if (modal) {
