document
  ...
  .addEventListener("submit", async function (e) {
    ...
    try {
      let response = await fetch("backend/edit-video.php", {
        method: "POST",
        body: formData,
      });
      ...
      if (response.ok) {
        ...
        throw new Error("Unable to update video. Please try again.");
      }
    } catch (error) {
      console.error("Error:", error);
      toastMessage = "Unable to update video. Please try again.";
      toastType = "error";
    }
